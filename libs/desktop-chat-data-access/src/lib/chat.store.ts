...
export const ChatStore = signalStore(
  ...
  withMethods((store) => ({
     ...
     * persistence resolves. Called by `WorkspaceDetailPage`'s
     * workspace-id effect via `ensureChatForWorkspace(id)` so the
     * composer can send before any chat tab has been visited.
     */
