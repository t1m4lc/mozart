...
const MZ_G: Record<HlmLoaderSize, string> = { xs: '1.5px', sm: '2px', md: '3px' };
...
@Component({
  ...
  styles: `
    ...
    span:nth-child(2),
    span:nth-child(8),
    span:nth-child(11) { visibility: hidden; }

    span:nth-child(1)  { animation-delay:   0ms; }
    span:nth-child(3)  { animation-delay: 100ms; }
    span:nth-child(4)  { animation-delay: 200ms; }
    span:nth-child(5)  { animation-delay: 300ms; }
    span:nth-child(6)  { animation-delay: 400ms; }
    span:nth-child(7)  { animation-delay: 500ms; }
    span:nth-child(9)  { animation-delay: 600ms; }
    span:nth-child(10) { animation-delay: 700ms; }
    span:nth-child(12) { animation-delay: 800ms; }
