...
- [ ] Voir scénarios complets dans `docs/engineering/release/release-validation-scenarios.md`

---

## Checklist Cloudflare (one-time, si pas encore fait)

Voir `docs/engineering/release/cloudflare-notes.md §5` pour la checklist complète :
