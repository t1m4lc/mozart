...
3. **Extract functional test scenarios** into `docs/engineering/testing/scenarios/` —
...
- `docs/engineering/testing/scenarios/README.md` + `docs/engineering/testing/scenarios/phase-N-*.md` +
  `docs/engineering/testing/scenarios/cross-phase-flows.md` — functional test scenarios
...
- `docs/engineering/testing/scenarios/*.md` — functional test scenarios produced by the
...
- **E2e tests** : the main investment. Test what the user does,
  ...
  binary. The scenarios in `docs/engineering/testing/scenarios/` define the contract.
...
- **Test scenarios** : implement every MUST-priority scenario
  from `docs/engineering/testing/scenarios/*.md`. SHOULD-priority scenarios in batch 2.
  COULD-priority scenarios deferred to post-Phase-9 polish. The
  exact scenario list lives in `docs/engineering/testing/scenarios/`, not duplicated
  here.
...
2. Every MUST-priority scenario from `docs/engineering/testing/scenarios/` passing
   locally + in CI
...
See `docs/engineering/prompts/phase-9-production-readiness.md` for the full
