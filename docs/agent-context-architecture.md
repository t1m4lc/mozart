...
Not a confusion between ChatThread and AgentRun — the model is correct (`docs/specs/mozart-product-architecture-specs.md:54-189`). The bug is purely in the bridge: the adapter discards history before it crosses Tauri.
