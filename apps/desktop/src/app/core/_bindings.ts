 ...
 */
async reopenWorkspace(workspaceId: string, targetUiStatus: string) : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("reopen_workspace", { workspaceId, targetUiStatus }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async startAgentRun(workspaceId: string, prompt: string, mode: string, onEvent: TAURI_CHANNEL<StreamEvent>) : Promise<Result<AgentRun, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("start_agent_run", { workspaceId, prompt, mode, onEvent }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async listWorkspaceDiffStats() : Promise<Result<WorkspaceDiffStats[], AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("list_workspace_diff_stats") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async stageFile(workspaceId: string, path: string) : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("stage_file", { workspaceId, path }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * `stage_file`.
 */
async unstageFile(workspaceId: string, path: string) : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("unstage_file", { workspaceId, path }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async isStaged(workspaceId: string, path: string) : Promise<Result<boolean, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("is_staged", { workspaceId, path }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * surface around it).
 */
async setWorkspaceSandboxLevel(workspaceId: string, level: string) : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_workspace_sandbox_level", { workspaceId, level }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * any prior entry.
 */
async authSaveSession(session: AuthSessionDto) : Promise<Result<null, AppError>> {
    try {
...
async getOnboardingCompleted() : Promise<Result<boolean, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_onboarding_completed") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async setOnboardingCompleted(value: boolean) : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_onboarding_completed", { value }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * crate-private.
 */
async detectProject(path: string) : Promise<Result<DetectedSummary, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("detect_project", { path }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async bootstrapProject(path: string) : Promise<Result<BootstrapResult, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("bootstrap_project", { path }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * UI for v0 (TODO-006).
 */
async initProjectRepoFromLocal(projectId: string) : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("init_project_repo_from_local", { projectId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async readProjectConfig(projectId: string) : Promise<Result<ProjectConfig, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("read_project_config", { projectId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async resetDatabaseWithDemoSeed() : Promise<Result<null, AppError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("reset_database_with_demo_seed") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
workspace_id: string }
export type AppError = { kind: "Db"; message: string } | { kind: "Io"; message: string } | { kind: "NotFound"; message: string } | { kind: "Validation"; message: string } | { kind: "AgentSpawn"; message: string } | { kind: "GitCmd"; message: string } | { kind: "Frozen"; message: string } | { kind: "MergeDirtyTree"; message: string } | { kind: "MergeBaseAhead"; message: string } | { kind: "StaleFile"; message: string } | { kind: "PathRefused"; message: string }
/**
 ...
 * JSON stays stable.
 */
export type AuthSessionDto = { token: string; 
/**
 ...
 */
export type BootstrapResult = { projectId: string; firstWorkspaceId: string; startChatId: string; 
/**
 ...
 */
source: string; detected: DetectedSummary; 
/**
 ...
 */
export type DetectedSummary = { setup: string | null; run: string | null; 
/**
 * Toolchain name from the winning probe (`"pnpm"`, `"cargo"`, ...).
 * `None` when no probe matched.
 */
stack: string | null; hasMozartDir: boolean }
/**
 ...
 */
export type ProjectConfig = { runJson: string; mergeMode: string; 
/**
 * `"repo"` or `"local"`.
 */
source: string }
...
export type StreamEvent = { kind: "stream_token"; text: string } | { kind: "tool_call"; id: string; name: string; args_json: string } | { kind: "tool_result"; id: string; ok: boolean; summary?: string | null } | { kind: "thinking"; id: string; text: string } | { kind: "cli_output"; line: string } | { kind: "status_update"; status: string } | { kind: "error"; message: string }
...
export type WorkspaceDiffStats = { workspace_id: string; added: number; removed: number }
