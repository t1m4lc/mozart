...
date: 2026-06-03
title: First silent update
---

`v0.1.0-beta.0.1` is a targeted patch for the issues reported right after the beta.0 launch. If you installed beta.0, the auto-updater delivers this silently — you'll see the "Restart to install" button appear after your next launch.

### New

- **"Restart to install" update notification.** This is the first update delivered over the air — if you have beta.0 installed, Mozart downloads this patch silently in the background and shows a "Restart to install" button when it's ready. Click it whenever you're at a good stopping point; nothing interrupts until you do.
