    ...
    <div class="mx-auto mt-16 mb-24 max-w-7xl px-4 sm:px-8">
      ...
      >
        <img
          ...
          [width]="width"
          [height]="height"
          alt="Mozart desktop: parallel Workspaces, agent timeline, and diff review running side by side. (screenshot v0.1.0-beta.2)"
          loading="eager"
          fetchpriority="high"
          decoding="async"
      ...
      >
        mozart-desktop &middot; v0.1.0-beta.2
      </figcaption>
    </div>
  `,
})
