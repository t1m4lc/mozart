    ...
    macro_rules! base_commands {
        ($($extra:tt)*) => {
            tauri_specta::collect_commands![
                ...
                commands::check_codex_install,
                commands::check_codex_session,
                commands::has_openai_key,
                commands::connect_openai,
                commands::disconnect_openai,
                commands::refresh_openai_connection,
